...
def train_aim_move_dueling(agent_role=Gunner, total_steps=1_000_000, buffer_capacity=100000, batch_size=64,
    ...
    agent = DuelingDQNAgent(state_size=22, batch_size=batch_size, epsilon_start=0.3)
